<script lang="ts">
    ...
    import { Idle, Sidebar } from '../../components'
    import { isPollingLedgerDeviceStatus, stopPollingLedgerStatus } from '../../lib/ledger'
    import { ongoingSnapshot } from '../../lib/migration'
    import { removeDisplayNotification, showAppNotification } from '../../lib/notifications'
    import { Platform } from '../../lib/platform'
    import { closePopup, openPopup, popupState } from '../../lib/popup'
    import { Settings, Staking, Wallet, DeveloperTools } from '..'
