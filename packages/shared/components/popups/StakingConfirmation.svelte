<script lang="ts">
    ...
    import { Button, Checkbox, Icon, Text, Tooltip } from '..'
    import { ledgerDeviceState } from '../../lib/ledger'
    ...
    import { STAKING_AIRDROP_TOKENS, STAKING_EVENT_IDS } from '../../lib/participation/constants'
    import { participationAction, isPartiallyStaked } from '../../lib/participation/stores'
    import { Participation, ParticipationAction, StakingAirdrop } from '../../lib/participation/types'
