<script lang="ts">
    ...
    import { Button, DeveloperIndicatorPill, HR, Icon, Modal, Text, Toggle } from '..'
    import { localize } from '@core/i18n'
    import { LocaleArguments } from '@core/i18n/types'
    import { ledgerDeviceState } from '../../lib/ledger'
    import { popupState, openPopup } from '../../lib/popup'
    import { openSettings } from '@core/router'
    import { LedgerAppName, LedgerDeviceState } from '../../lib/typings/ledger'
    import { diffDates, getBackupWarningColor, getInitials, isRecentDate } from '../../lib/helpers'
